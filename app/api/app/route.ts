...
export async function GET(request:Request){
  ...
  const [community,membersResult,residentsResult,expenses,decisions,notifications,invitations]=await Promise.all([
