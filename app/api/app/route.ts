...
export async function GET(request:Request){
  ...
  const [community,membersResult,residentsResult,expenses,announcements,decisions,notifications,invitations]=await Promise.all([
